  ...
  return (
    ...
    <div className="bg-[#F5F8FA] ">
      ...
      <div className=" w-full -z-10 ">
          <div className="bg-[#2C3F4F] h-[596px] pt-[249px]">
            <div className="flex flex-col justify-center items-center text-center text-white">
              ...
              <p className="leading-7 pt-[29px]">
                ...
                <span className="block">
                  Piano-led deep house with fat bassline, huge beats & soulful
                  male vocal. With
                </span>
                fat bassline, huge beats & soulful male vocal.
              </p>
              <h3 className="mt-[15px] text-[22px] font-semibold">
                Robart Adison
              </h3>
        ...
        <div className="h-[305px]  w-full mx-[60px] bg-white rounded-lg px-[38.75px] py-[53px] z-20 absolute -top-[99px]">
          <div className="flex gap-[103.5px]">
            {testimonialData.map((item) => (
              <div
                ...
                key={item?.id}
              >
                <Image src={item?.image} width={52} height={70} alt="" />
